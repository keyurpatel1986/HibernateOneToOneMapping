package com.journal.hibernate.main;
...
import com.journal.hibernate.model.Customer;
import com.journal.hibernate.util.HibernateUtil;
...
public class HibernateOneToOneMain {
	...
	private static Txn buildDemoTransaction() {
		...
		cust.setEmail("keyurpatel123@gmail.com");
		cust.setName("keyur patel");

		txn.setCustorme(cust);
